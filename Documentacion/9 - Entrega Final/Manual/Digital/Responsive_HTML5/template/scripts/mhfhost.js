var gsNoTopics="No se encontraron resultados";
var gsLoadXmlFailed="No se pudo cargar el archivo XML";
var gsInitDatabaseFailed="No se pudo inicializar la base de datos";
var gsInvalidExpression="La cadena de búsqueda que ha escrito no es válida";
