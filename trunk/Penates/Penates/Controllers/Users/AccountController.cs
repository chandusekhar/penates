    ...
    public class AccountController : BaseController
    {
        ...
        public ActionResult ChangeMyPassword() {
            ...
            if (String.IsNullOrWhiteSpace(userName)) {
                RedirectToAction("UnsignedUser", "Error");
            }
            ChangeMyPasswordViewModel model = new ChangeMyPasswordViewModel() {
                UserName = userName
            };
            return View(model);
        }
        ...
        [RoleValidation(RoleType.All)]
        public ActionResult ChangeMyPassword(ChangeMyPasswordViewModel model) {
            try {
                if (ModelState.IsValid) {
                    UserService service = new UserService();
                    if (service.changePassword(model.UserName, model.OldPassword, model.NewPassword)) {
                        DashBoardViewModel dashModel = new DashBoardViewModel();
                        dashModel.Error = false;
                        dashModel.Message = Resources.Messages.OperationSuccessfull + ": " + Resources.Messages.PasswordChangeSuccessfull;
                        return RedirectToAction("HomeDashboards", "Home", dashModel);
                    } else {
