...
namespace Penates.Interfaces.Repositories {
    public interface IDepositRepository {
        ...
        Deposit getDepositInfo(long id);

        IQueryable<Deposit> getData(long dcID);

        IQueryable<Deposit> search(IQueryable<Deposit> query, string search);

        IQueryable<Deposit> search(IQueryable<Deposit> query, List<string> search);
        ...
        /// <returns>true si lo logra o excepcion</returns>
        /// <exception cref="ForeignKeyConstraintException">Hay que capturarla en el controller y pasar el error</exception>
        bool saveCategories(long depositID, List<long> categoryiesIDs);
        ...
        bool deleteCategories(long depositID);
